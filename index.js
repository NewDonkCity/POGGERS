...
client.on('message', message => {
	...
	if (message_content == "dab") {
		...
		if (Math.floor(Math.random() * 2) == 0) {
        	...
        	if (Math.floor(Math.random() * 2) == 0) {
            		message.react('727577562745929787');
        	}
        	if (Math.floor(Math.random() * 2) == 0) {
		...
		var face3 = Math.floor(Math.random() * 6);
		if (face3 == 0) {
	...
	if (message_content.includes("guess ill die")) {
		message.react('727577559633494340');
	}
	...
	if (message_content.includes("ing gooo")) {
		if (Math.floor(Math.random() * 2) == 0) {
            		message.react('727577560690720829');
        	}
        	if (Math.floor(Math.random() * 2) == 0) {
	...
	if (message_content.includes("in gooo")) {
		if (Math.floor(Math.random() * 2) == 0) {
            		message.react('727577560690720829');
        	}
        	if (Math.floor(Math.random() * 2) == 0) {
