...
client.on('message', message => {
	...
	if (message_content.includes("love me..")) {
    	...
    	if (message_content.includes("do i love")) {
        	var face = Math.floor(Math.random() * 8);
		if (face == 0) {
    			message.react('682711729116938266');
        	}
    	...
    	if (message_content.includes("does anyone love")) {
        	var face = Math.floor(Math.random() * 8);
		if (face == 0) {
    			message.react('682711729116938266');
        	}
    	...
    	if (message_content.includes("does everyone love")) {
        	var face = Math.floor(Math.random() * 8);
		if (face == 0) {
    			message.react('682711729116938266');
        	}
    	...
    	if (message_content.includes("does anybody love")) {
        	var face = Math.floor(Math.random() * 8);
		if (face == 0) {
    			message.react('682711729116938266');
        	}
    	...
    	if (message_content.includes("does everybody love")) {
        	var face = Math.floor(Math.random() * 8);
		if (face == 0) {
    			message.react('682711729116938266');
        	}
